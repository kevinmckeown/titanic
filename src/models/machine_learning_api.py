...
#todo
model_filepath = '/home/kevin/Projects/titanic/models/lr_model.pkl'
scaler_filepath = '/home/kevin/Projects/titanic/models/lr_scaler.pkl'

scaler = pickle.load(open(scaler_filepath))
model = pickle.load(open(model_filepath))

#todo: take unprocessed input and process it within api
# columns
